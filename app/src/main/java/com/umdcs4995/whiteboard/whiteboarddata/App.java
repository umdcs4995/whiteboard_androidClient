...
//        });
    ...
    public String getTopicName() {
        String topicName = getString(R.string.authors);
...
//    }
    ...
    /**
     * Returns true iff this is the whiteboard app.
     */
    public static boolean isWhiteboardApp() {
        //return BuildConfig.SITE_NAME.equals("whiteboard");
        return true;
    }
...
//                ApiContentProvider.getAuthority());
     ...
     */
    public void setLastSyncTime(User user) {
        String lastSyncTimeKey = getLastSyncTimeKey(user);
        SharedPreferences preferenceFile = getSharedPreferences(PREFERENCE_FILE,
    ...
    public long getLastSyncTime() {
        ...
        String lastSyncTimeKey = getLastSyncTimeKey(mUser);
        SharedPreferences preferenceFile = getSharedPreferences(PREFERENCE_FILE,
                MODE_PRIVATE | MODE_MULTI_PROCESS);
    ...
    private String getLastSyncTimeKey(User user) {
        return LAST_SYNC_TIME + "_"; /* + user.getUserid();*/
    }
